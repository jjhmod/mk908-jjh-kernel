...
static struct cpufreq_frequency_table ddr_dvfs_table[] = {
	...
	{.frequency = 400 * DVFS_KHZ, .index = 1000 * DVFS_MV},
	{.frequency = 500 * DVFS_KHZ, .index = 1050 * DVFS_MV},
	{.frequency = 600 * DVFS_KHZ, .index = 1100 * DVFS_MV},
	//{.frequency = 700 * DVFS_KHZ, .index = 1150 * DVFS_MV},//JJH ADDED
	//{.frequency = 800 * DVFS_KHZ, .index = 1200 * DVFS_MV},//JJH ADDED	
	{.frequency = CPUFREQ_TABLE_END},
};
...
static struct cpufreq_frequency_table gpu_dvfs_table[] = {
	...
	{.frequency = 600 * DVFS_KHZ, .index = 1200 * DVFS_MV},	//Wasn't here
	{.frequency = CPUFREQ_TABLE_END},
};

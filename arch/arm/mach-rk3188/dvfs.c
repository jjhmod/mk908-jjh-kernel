...
//	{.frequency  = 312 * DVFS_KHZ, .index	= 900 * DVFS_MV},
//	{.frequency  = 504 * DVFS_KHZ, .index	= 925 * DVFS_MV},
	{.frequency  = 816 * DVFS_KHZ, .index	= 1000 * DVFS_MV},
//	{.frequency  = 1008 * DVFS_KHZ, .index	= 1075 * DVFS_MV},
//	{.frequency  = 1200 * DVFS_KHZ, .index 	= 1150 * DVFS_MV},
//	{.frequency  = 1416 * DVFS_KHZ, .index 	= 1250 * DVFS_MV},
//	{.frequency  = 1608 * DVFS_KHZ, .index 	= 1350 * DVFS_MV},
	{.frequency	= CPUFREQ_TABLE_END},
};

static struct cpufreq_frequency_table ddr_dvfs_table[] = {
//	{.frequency = 100 * DVFS_KHZ, .index = 1100 * DVFS_MV},
//	{.frequency = 200 * DVFS_KHZ, .index = 975 * DVFS_MV},
//	{.frequency = 300 * DVFS_KHZ, .index = 975 * DVFS_MV},
//	{.frequency = 400 * DVFS_KHZ, .index = 1100 * DVFS_MV},
//	{.frequency = 500 * DVFS_KHZ, .index = 1250 * DVFS_MV},
//	{.frequency = 600 * DVFS_KHZ, .index = 1200 * DVFS_MV},
//	{.frequency = 700 * DVFS_KHZ, .index = 1350 * DVFS_MV}, //JJH ADDED
	{.frequency = 800 * DVFS_KHZ, .index = 1300 * DVFS_MV}, //JJH ADDED	
	{.frequency = CPUFREQ_TABLE_END},
};
...
//	{.frequency = 500 * DVFS_KHZ, .index = 1175 * DVFS_MV}, //WAS 1200
	{.frequency = 600 * DVFS_KHZ, .index = 1200 * DVFS_MV},
//	{.frequency = 650 * DVFS_KHZ, .index = 1225 * DVFS_MV},	//Wasn't here
	{.frequency = CPUFREQ_TABLE_END},
};
...
static struct cpufreq_frequency_table dep_cpu2core_table[] = {
	...
	// {.frequency = 504 * DVFS_KHZ, .index    = 1025 * DVFS_MV},
	   {.frequency = 816 * DVFS_KHZ, .index    = 1000 * DVFS_MV},//logic 1.050V
	...
	// {.frequency = 1608 * DVFS_KHZ,.index    = 1150 * DVFS_MV},//logic 1.175V
	{.frequency	= CPUFREQ_TABLE_END},
};
